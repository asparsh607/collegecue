...
urlpatterns = [
    ...
    path('forgot2',Forgot2_view.as_view(),name="forgot2"),
    ...
    path('job_portal', Subscriber_view.as_view(), name='job_portal'),
    path('subscriber', Subscriber_view1.as_view(), name='subscriber'),
    path('verify_otp1',Verify_view.as_view(),name="verify_otp1"),
